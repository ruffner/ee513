...
reverbEn = 0;  %  Note simulation will take longer with room reverberations
...
% create randomly distributed array of speakers
% that are .5m away from all walls in a 3.6m x 3.6m room
spos=2.6.*rand(3,6)+.5; 
...
micspacing = 1;
mpos = regmicsplane(micplane, micspacing, 'Hex');  % generate mics rectilinearly in a plane
