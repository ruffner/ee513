...
f12p = 10e3;  %  Corresponding upper frequency limit
...
%  windowed segment
prot.cliptype = 'cnsc';  %  Select clipping type
prot.cliplevel = 0.8;    %  Select clipping level (percentage of maximum between 0 and 1)
