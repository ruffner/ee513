...
% much code adapted from Dr. Kevin Donohue's mindistex.m, 
% featureexhw.m and the provided solution to HW7.
...
bsize = 55; % number of files in each bootstrap
...
bar(fc)
xlabel('Various Features')
ylabel('FC in STDs')
title('Fishers criterion for selected features')


save('cov', 'cinv', 'mu1', 'mu2')
