...
%  for each feature are the same for the entire class.  If
...
nfeature = 100;  %  Number of features used to discriminate processes
...
m0 = -.6*ones(nfeature,1);  % means for each feature in class 0
m1 = .6*ones(nfeature,1);  % means for each feature in class 1
s0 = 3*ones(nfeature,1);  % standard devations for each feature in class 0
s1 = 3*ones(nfeature,1);  % standard deviaions for each feature in class 1
